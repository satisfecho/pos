...
**012 handoff (2026-04-30 — end of file, consistent with Status for tester):** After verification **FAIL**, task file is **`WIP-195-20260428-0238-push-to-master.md`**; issue **#195** should carry **`agent:wip`** until secrets / green **Deploy to amvara9** or documented **§4** parity, then **`wip` → `untested`** for re-test. Latest **`master`** **Deploy to amvara9** remains run **`24773000757`**, **`failure`** — criterion **(2)** unchanged.
