...
**Handoff (`012-feature-coder-handoff.md`, 2026-04-30):** Ran **`./scripts/git-sync-development.sh`** at repo start. Per **`TASKS-README.md`** and **`docs/agent-loop.md`**, **wip → untested** when implementation is done and **Testing instructions** are appended: renamed **`WIP-195-20260428-0238-push-to-master.md`** → **`UNTESTED-195-20260428-0238-push-to-master.md`**; **`gh issue edit 195 --repo satisfecho/pos --add-label "agent:untested"`** and **`--remove-label "agent:wip"`**. **Tester:** rename **`UNTESTED-…` → `TESTING-…`** when verification starts; criterion **(2)** may still **FAIL** until Actions secrets, a green **`master`** **Deploy to amvara9** run, or **§4** parity is documented.
