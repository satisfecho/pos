...
_AR: dict[str, str] = {
    **_EN,
    "sheet_summary": "ملخص",
    "sheet_reservations": "الحجوزات",
    "sheet_by_product": "حسب المنتج",
    "sheet_by_category": "حسب الفئة",
    "sheet_by_table": "حسب الطاولة",
    "sheet_by_waiter": "حسب النادل",
    "date": "التاريخ",
    "revenue_cents": "الإيرادات (سنت)",
    "cost_cents": "التكلفة (سنت)",
    "profit_cents": "الربح (سنت)",
    "orders": "الطلبات",
    "total": "الإجمالي",
    "source": "المصدر",
    "count": "العدد",
    ...
    "table": "الطاولة",
    "waiter": "النادل",
    "source_public": "عام (عبر الإنترنت)",
    "source_staff": "الموظفين",
    "res_status_booked": "محجوز",
    "res_status_seated": "على الطاولة",
    "res_status_finished": "مكتمل",
    "res_status_cancelled": "ملغى",
    "res_status_no_show": "لم يحضر",
}
