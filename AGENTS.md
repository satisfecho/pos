...
**Multi-agent task workflow (optional):** Task pipeline and roles modeled on mac-stats-reviewer — see **`docs/agent-loop.md`** (target `agents/tasks/`, coder/tester/closing/committer handoffs).
