...
sed -i "s#window.__API_URL__ || 'http://localhost:8020'#window.__API_URL__ || '${API_URL_ESCAPED}'#g" /app/src/index.html
sed -i "s#window.__WS_URL__ || 'ws://localhost:8021'#window.__WS_URL__ || '${WS_URL_ESCAPED}'#g" /app/src/index.html
